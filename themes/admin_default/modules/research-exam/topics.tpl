                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="javascript:void(0);" onclick="nv_del_topic({ROW.id})" class="btn btn-xs btn-danger"><em class="fa fa-trash-o"></em> {GLANG.delete}</a>
                        </td>
                    </tr>
                    <!-- END: row -->
                    <!-- END: list -->
...
<div class="panel panel-default">
    <div class="panel-heading">
        {LANG.topic_add} / {LANG.topic_edit}
    </div>
    <div class="panel-body">
        <!-- BEGIN: form -->
        <form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&{NV_NAME_VARIABLE}={MODULE_NAME}&{NV_OP_VARIABLE}={OP}" method="post">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">{LANG.topic_title} <span class="text-danger">(*)</span></label>
                <div class="col-sm-20">
                    <input type="text" class="form-control" name="title" value="{DATA.title}" required />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">{LANG.topic_note}</label>
                <div class="col-sm-20">
