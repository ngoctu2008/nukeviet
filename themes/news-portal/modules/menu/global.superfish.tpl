...
<script	type="text/javascript" src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/js/superfish/hoverIntent.js"></script>
<script	type="text/javascript" src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/js/superfish/superfish.js"></script>
<script	type="text/javascript" src="{NV_BASE_SITEURL}{NV_ASSETS_DIR}/js/superfish/supersubs.js"></script>
<style type="text/css">
	.style_nav {
		position: relative;
