<!-- BEGIN: main -->
<div class="bigbox section" id="bigbox"><div class="block">
<div class="block-content"><div class="mastoras">
...
<div class="mastoras_wide left">
	<div class="thumb">
		...
		<a title="{ROW.cat_title}" href="{ROW.cat_link}"><h1>{ROW.cat_title}</h1></a>
	</div>
	<div class="featuredPost lastPost">
		<h2 class="postTitle" style="margin-top: 10px">
		<a title="{ROW.title}" href="{ROW.link}">{ROW.title}</a>
		</h2>
