<!-- BEGIN: main -->
<div class="xem-ngay-construction">
    <h2 class="text-center mb-4 text-success">{LANG.construction_title}</h2>

    <form action="{ACTION_URL}" method="post" class="mb-5">
        <div class="panel panel-success">
            <div class="panel-heading">{LANG.construction_title}</div>
            <div class="panel-body">
                <div class="form-group row">
                    <label class="col-sm-6 col-md-6 control-label">Năm sinh Gia chủ (*)</label>
                    <div class="col-sm-18 col-md-18">
                        <input type="number" name="birth_year" class="form-control" value="{DATA.birth_year}" required placeholder="VD: 1980">
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="text-center">
            <button type="submit" name="submit" value="1" class="btn btn-success btn-lg">{LANG.submit}</button>
        </div>
    </form>
